...
data.plot(color='variable', title='Shadow price ($\lambda_t^{load}$) and future opportunity costs\nof hydropower producer (OC) in EUR/MWh', marker="d", markersize=5, ax=ax, fill_between=False, cmap='tab10')
...
plt.plot([38, 245], [0, 0], color='#1687A7', linestyle='dotted', linewidth=3)
plt.plot([245, 245], [0, 90], color='#1687A7', linestyle='dotted', linewidth=3)
plt.plot([245, 420], [90, 155.8], color='#1687A7', linewidth=3)




ax.text(310, 45,"$p_t^{H_2}=f(CO_2)$", color='#1687A7', fontsize=12)
plt.plot([295, 305], [48, 48], color='#1687A7', linewidth=2)
